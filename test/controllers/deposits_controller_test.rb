...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference("Deposit.count") do
      post deposits_url, params: { deposit: { name_bank: @deposit.name_bank, quantity: @deposit.quantity, total: @deposit.total, unit_price: @deposit.unit_price } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { name_bank: @deposit.name_bank, quantity: @deposit.quantity, total: @deposit.total, unit_price: @deposit.unit_price } }
